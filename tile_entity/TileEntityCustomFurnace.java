...
private ItemStack[] furnaceItemStacks = new ItemStack[3]; // how many slots in the block
...
public ItemStack getStackInSlot(int slot) {
	return this.furnaceItemStacks[slot]; // ERROR
}
...
public String getInventoryName() {
	return this.hasCustomInventoryName() ? this.furnaceName : "No Name";//Custom Furnace
}
...
public void updateEntity() {
	...
	if (flag != this.furnaceBurnTime > 0) {
		flag1 = true;
		CustomFurnace.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
	}
...
public static int getItemBurnTime(ItemStack itemstack){
	if(itemstack == null){
		...
		if(item == AllItems.itemCheese) return 1600;
		if(item instanceof ItemTool && ((ItemTool) item).getToolMaterialName().equals("GOLD")) return 300;
