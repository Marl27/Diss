...
public class GuiCustomFurnace extends GuiContainer{
	...
	//("fm:textures/gui/container/castle_block.png");
	private TileEntityCustomFurnace tileFurnace;

	public GuiCustomFurnace(InventoryPlayer invPlayer, TileEntityCustomFurnace tile) {
		super(new ContainerCustomFurnace(invPlayer, tile));
