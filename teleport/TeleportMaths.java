...
public class TeleportMaths extends Block{

	public TeleportMaths(Material material) {
		super(material);
			...
			if (org.lwjgl.input.Keyboard.isKeyDown(org.lwjgl.input.Keyboard.KEY_NUMPAD1)){
				...
				for(int i = y - 2; i > Y; i-- ){
					...
					if (world.blockExists(x, i, z)){
						...
						System.out.println(world.getBlock(x, i, z) == Block.getBlockFromName("TeleportMaths"));
						System.out.println("**********************************************");
						System.out.println("**********************************************");
						System.out.println("**********************************************");

						if (world.getBlock(x, i, z) != this.getBlockFromName("TeleportMaths")) { 
							//player.setPositionAndUpdate(x + 0.5d, i + 1, z + 0.5d);
							player.setPositionAndUpdate(99.7d , 237.500d, 99.7d);
